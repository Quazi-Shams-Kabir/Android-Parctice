...
public class MainActivity extends AppCompatActivity {
    public static final String KEY1 = "com.example.alertdialogassigment.Q1";
    public static final String KEY2 = "com.example.alertdialogassigment.Q2";
    public static final String KEY3 = "com.example.alertdialogassigment.Q3";
    public static final String KEY4 = "com.example.alertdialogassigment.Q4";
    int selectedItem1;
    int selectedItem4;
